package org.example.tacocloud.JdbcRepository;
...
@Repository
public class JdbsIngredientRepository implements IngredientRepository {
    private final JdbcTemplate jdbcTemplate;

    public JdbsIngredientRepository(JdbcTemplate jdbcTemplate) {
